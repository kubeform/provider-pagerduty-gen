...
replace github.com/terraform-providers/terraform-provider-pagerduty => github.com/PagerDuty/terraform-provider-pagerduty v1.11.1-0.20211025223820-5b21090fbd05
